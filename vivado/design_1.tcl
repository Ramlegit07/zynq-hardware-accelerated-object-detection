...
proc create_root_design { parentCell } {
  ...
  # Create instance: conv2d_hls_0, and set properties
  set conv2d_hls_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:conv2d_hls:1.0 conv2d_hls_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins conv2d_hls_0/s_axi_control]
  ...
  connect_bd_intf_net -intf_net conv2d_hls_0_m_axi_gmem [get_bd_intf_pins conv2d_hls_0/m_axi_gmem] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  ...
  [get_bd_pins conv2d_hls_0/ap_clk] \
  ...
  [get_bd_pins conv2d_hls_0/ap_rst_n]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces conv2d_hls_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs conv2d_hls_0/s_axi_control/Reg] -force
